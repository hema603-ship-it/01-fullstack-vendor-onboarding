...
describe('VendorList', () => {
  ...
  it('calls deleteVendor when delete button is clicked', async () => {
    ...
    await wrapper.find('button.vendor-delete').trigger('click');

    expect(window.confirm).toHaveBeenCalledWith('Are you sure you want to delete the vendor?');
